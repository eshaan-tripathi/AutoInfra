      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl py-32 sm:py-48 lg:py-56 text-center">
          <h1 className="text-3xl font-semibold tracking-tight text-white sm:text-6xl">
            Automate Your Cloud Infrastructure. Deploy Faster, Smarter, and Securely.
          </h1>
          <p className="mt-8 text-lg font-medium text-gray-400 sm:text-xl/8">
            AutoInfra helps businesses provision, scale, and manage cloud resources effortlessly on AWS, Azure, and GCP. Focus on innovation while we handle infrastructure.
          </p>
